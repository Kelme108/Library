    ...
    render() {
        return (
            ...
            <Navbar bg="dark" variant="dark" expand="lg" className={estilo.cabecalho}>
                <Container>
                    <Navbar.Brand className={estilo.logo}><Link to="/listagem" className="nav-link"><img src="/logo.png" width="30" height="30" alt="IFSP Logo" />&nbsp;KelmeLivros</Link></Navbar.Brand>
